## intent:what_is_convo_agent
- What is a conversational agent? How does it work?
- What is a conversational agent?
- whats an agent
- i don't know what a conversational agent is

## intent:how_can_i_increase_conversion
- How can I increase my website visit conversion rate
- what ways can I improve my website experience
- how does one improve their site conversion?
- I want to improve my site converion rate
- I need to decrease my bounce rate
- how can I get more out of my seo budget?
- I want to maximize my seo budget
- How can i improve my website performance?
- how do real-time conversations help me convert more prospects into paying customers?

## intent:recent_trends
- Do you have recent trends regarding consumer online buying habits?
- recent trends
- what trends are happening right not?
- what's the data say about conversational agents
- what's the data say about chatbots
- data and trends

## intent:how_long_do_agents_work
- How can I avoid customer service issues on the weekend or at night?
- How does a chatbot help improve my customer service and response time
- How does a conversational agent help cut my response rates?

## intent:why_should_i_talk_to_smartchat
- Why should I schedule a call with someone from SmartChat Labs?
- why would I do that
- why should I talk to someone on the team when
...
## intent:fetch
- What is the meaning of [Dog](word)
- What does [example](word) mean
- meaning of [life](word)
- [egg](word) meaning
- What does [weather](word) mean
- get me the meaning of [poor](word)
- then what does [field](word) mean
- What do you mean by [body](word)
- [god](word) means
- what is a [robot](word)
- What is the meaning of [cat](word)
- What does [church](word) mean
- meaning of [mankind](word)
- [sled](word) meaning
- What does [computer](word) mean
- get me the meaning of [rich](word)
- then what does [keyboard](word) mean
- What do you mean by [phone](word)
- [man](word) means
- what is a [fish](word)
- What is the meaning of [brochure](word)
- What does [whiteboard](word) mean
- meaning of [marker](word)
- [staples](word) meaning
- What does [brain](word) mean
- get me the meaning of [suit](word)
- then what does [cube](word) mean
- What do you mean by [cord](word)
- [woman](word) means
- what is a [letter](word)
- What is the meaning of [palace](word)
- What does [president](word) mean
- meaning of [tie](word)
- [ham](word) meaning
- What does [eyebrows](word) mean
- get me the meaning of [super](word)
- then what does [gamble](word) mean
- What do you mean by [dice](word)
- [globe](word) means
- what is a [chair](word)
- What is the meaning of [paper](word)
- What does [sprinting](word) mean
- meaning of [base](word)
- [punch](word) meaning
- What does [stamp](word) mean
- get me the meaning of [office](word)
- then what does [calculator](word) mean
- What do you mean by [pen](word)
- [bottle](word) means
- what is a [chicken](word)
- What is the meaning of [apple](word)
- What does [earch](word) mean
- meaning of [helmet](word)
- [hat](word) meaning
- What does [spider](word) mean
- get me the meaning of [sugar](word)
- then what does [face](word) mean
- What do you mean by [glasses](word)
- [hero](word) means
- what is a [bird](word)
- What is the meaning of [design](word)
- What does [platform](word) mean
- meaning of [chassis](word)
- [knot](word) meaning
- What does [model](word) mean
- get me the meaning of [stick](word)
- then what does [rock](word) mean
- What do you mean by [applications](word)
- [procedures](word) means
- what is a [screen](word)
- What is the meaning of [falcon](word)
- What does [tutorial](word) mean
- meaning of [monkey](word)
- [timer](word) meaning
- What does [blue](word) mean
- get me the meaning of [wealthy](word)
- then what does [backstroke](word) mean
- What do you mean by [piano](word)
- [free](word) means
- what is a [triangle](word)
- What is the meaning of [system](word)
- What does [modify](word) mean
- meaning of [lamp](word)
- [download](word) meaning
- What does [cells](word) mean
- get me the meaning of [documentation](word)
- then what does [games](word) mean
- What do you mean by [punch](word)
- [red](word) means
- what is a [heart](word)
- What is the meaning of [blood](word)
- What does [hand](word) mean
- meaning of [leg](word)
- [arm](word) meaning
- What does [shoes](word) mean
- get me the meaning of [t-shirt](word)
- then what does [music](word) mean
- What do you mean by [tab](word)
- [movie](word) means
- what is a [director](word)
- What is the meaning of [actor](word)
- What does [help](word) mean
- meaning of [software](word)
- [command](word) meaning
- What does [toolbar](word) mean
- get me the meaning of [figures](word)
- then what does [explanation](word) mean
- What do you mean by [insert](word)
- [hatch](word) means
- what is a [collar](word)
- What is the meaning of [fetch](word)
- What does [ear](word) mean
- meaning of [tail](word)
- [wags](word) meaning
- What does [toy](word) mean
- get me the meaning of [play](word)
- then what does [teeth](word) mean
- What do you mean by [tongue](word)
- [dentist](word) means
- what is a [box](word)
- what do you mean by [rainfall](word)
- what is a [refrigerator](word)
- what is a [doctor](word)
- what is [armageddon](word)
...
## intent:jeep_weather
- should I take the top off of the Jeep today
- do you think I should take the top off of the Jeep
- is today good to take the doors off of the Jeep
- should I take the doors off of the Jeep today
- is it Jeep weather today
- jeep weather
- should I take the top off of the Jeep today
- do you think I should take the top off of the Jeep
- is today good to take the doors off of the Jeep
